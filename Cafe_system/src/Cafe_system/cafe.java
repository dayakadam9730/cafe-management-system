...
public class cafe {
	...
	private void initialize() {
		...
		double tea = 10, coffee = 20, icetea = 20, icecoffee = 30, orangejuice = 20, applejuice = 30, coke = 40,
				thumbsup = 40;

		frame = new JFrame();
		frame.getContentPane().setBackground(new Color(255, 250, 250));
		frame.setBounds(0, 0, 1260, 725);
		...
		panel_1.setBounds(34, 0, 1164, 53);
		...
		lblCafeManagementSystem.setBounds(311, 0, 671, 53);
		...
		panel_2.setBounds(427, 64, 374, 533);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Select a Drink ", "Tea", "Coffee", "Ice Tea",
		...
		panel_3.setBounds(824, 64, 374, 533);
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (txtDisplay.getText().length() > 0) {
					...
					strB.deleteCharAt(txtDisplay.getText().length());
		...
		panel_4.setBounds(34, 606, 1169, 53);
		...
		btnReset.setBounds(100, 11, 85, 26);
		...
		btnTotal.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				double total = itm1 * tot1 + itm2 * tot2 + itm3 * tot3 + itm4 * tot4 + itm5 * tot5 + itm6 * tot6
						+ itm7 * tot7;
		...
		btnTotal.setBounds(500, 11, 177, 26);
		...
		btnExit.setBounds(942, 11, 85, 26);
		panel_4.add(btnExit);
	}
}
